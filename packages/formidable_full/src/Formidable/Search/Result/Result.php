...
class Result extends SearchResult
{
    ...
    public function getSearchResultBulkMenus()
    {
        ...
        $menu->addItem(new LinkItem('#', t('Resend mail'), [
            ...
            'data-bulk-action-url' => URL::to('/formidable/dialog/dashboard/results/resend').'?formID='.$formID.'&ccm_token='.$result_token,
        ...
        $menu->addItem(new LinkItem('#', t('Export'), [
            ...
            'data-bulk-action-url' => URL::to('/formidable/dialog/dashboard/results/csv').'?formID='.$formID.'&ccm_token='.$result_token,
        ]));
        ...
        $menu->addItem(new LinkItem('#', t('Delete'), [
            ...
            'data-bulk-action-url' => URL::to('/formidable/dialog/dashboard/results/delete').'?formID='.$formID.'&ccm_token='.$result_token,
            'data-bulk-action-dialog-width' => '520',
            'data-bulk-action-dialog-height' => '400',
        ]));

...
<style> 
    ...
    .formidable .formidable_row, .formidable .formidable_row .element { clear:both; overflow: hidden; }
                                                            ...
                                                            <div class="help-block">
                                                                <div id="<?php echo $element->getHandle() ?>_counter" class="counter" type="<?php echo $element->getPropertyValue('min_max_type') ?>" min="<?php echo $element->getPropertyValue('min_value') ?>" max="<?php echo $element->getPropertyValue('max_value') ?>">
                                                                    <?php if ($element->getPropertyValue('max_value') > 0) { ?>
                                                                        <?php  echo t('You have') ?> <span id="<?php echo $element->getHandle() ?>_count"><?php echo $element->getPropertyValue('max_value') ?></span> <?php  echo ($element->getPropertyValue('min_max_type')!='value')?strtolower($element->getProperty('min_max')[$element->getPropertyValue('min_max_type')]):t('characters'); ?> <?php echo t('left')?>.
                                                                    <?php } ?>
                                                                </div>
                                                            </div>
                                                        <?php } ?>

					...
					<div id="ccm-tab-content-properties" class="ccm-tab-content">
	                    <fieldset class="form-horizontal">
	                        <div class="form-group">
	                            <div class="col-sm-12">
	                                <p><?php echo t('Give your mail a name!'); ?></p>
	                            </div>
	                        </div>

	                        <div class="form-group">
	                            <?php echo $form->label('label', t('Label'), array('class' => 'col-sm-3')) ?>
	                            <div class="col-sm-9">
	                                <?php echo $form->text('label', $mailing->getLabel(), array('placeholder' => t('Label for mail')))?>
	                            </div>
							</div>
						</fieldset>
					</div>
	                        ...
	                        <div class="form-group">
	                            ...
	                            <div class="col-sm-9">
	                                <div class="input-group">
	                                    <div class="checkbox">
											<label>
												 <?php echo $form->checkbox('send_cc', 1, $mailing->getSendType()=='cc')?>
												 <?php echo t('Use CC instead of BCC for sending mail') ?>
											</label>
										</div>
	                                </div>
	                            </div>
			        	...
			        	<fieldset>
	                    	...
	                    	<div class="form-group">
	                            ...
	                            <div class="col-sm-9">
		                                		...
		                                		foreach($attachments as $fID) { ?>
		                                			<div class="input attachment_row">
														...
														<div class="input-group-buttons">
															...
															<a href="javascript:;" onclick="ccmFormidableFormMailingRemoveAttachment($(this));" class="btn btn-danger option_button" <?php if (is_array($attachments) && count($attachments)) {?>disabled="disabled"<?php } ?>>-</a> 
														</div>
													</div>		                                			
		                                			<?php
		                                			$i++;
	                                ...
	                                <div id="new_attachment" style="display:none;">

...
class Qrcode
{
    ...
    private function loadECC()
    {
        ...
        $filename = DIR_PACKAGES . "/pdf_designer/data/qrv" . $this->version . "_" . $this->ec . ".dat";
    ...
    private function makeECC()
    {
        ...
        $filename = DIR_PACKAGES . "/pdf_designer/data/rsc" . $this->rs_ecc_codewords . ".dat";
    ...
    private function makeMatrix()
    {
        ...
        $this->final = unpack("C*", file_get_contents(DIR_PACKAGES . '/pdf_designer/data/modele' . $this->version . '.dat'));

...
use Loader;
  ...
  class agreementfs extends pageController{
    public function view($variables = null){
      ...
      if($lang){
        $linkReview = 'https://my.abcparts.be/nl/agreementfs/review/' . $lang;
        $linkManual = 'https://my.abcparts.be/nl/agreementfs/manual/'. $lang;
      }else{
        $linkReview = 'https://my.abcparts.be/nl/agreementfs/review/nl';
        $linkManual = 'https://my.abcparts.be/nl/agreementfs/manual/nl';
      }
    ...
    public function review($variables = null){
      ...
      if($lang){
        $linkSign = 'https://my.abcparts.be/nl/agreementfs/signed/' . $lang;
        $linkHome = 'https://my.abcparts.be/nl/agreementfs/' . $lang;
      }else{
        $linkSign = 'https://my.abcparts.be/nl/agreementfs/signed/nl';
        $linkHome = 'https://my.abcparts.be/nl/agreementfs/nl';
      }

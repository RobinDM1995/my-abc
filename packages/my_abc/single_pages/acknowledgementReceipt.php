    ...
    <div class="pagebackgroundag">
      ...
      <div class="row">
        <div class="col-md-10 col-md-offset-1">
          ...
          <span class="term"><?php echo t('Geldig van %1$s tot 31/12/2021', $datum);?></span>
        </div>
      </div>
      ...
      <div class="row">
        <div class="col-md-10 col-md-offset-1">
          ...
          <ul>
            ...
            <li><?php echo t('Een kilometervergoeding heen en weer van € 0,80/km');?></li>
      ...
      <div class="row">
        <div class="col-md-10 col-md-offset-1">
          ...
          <div class="col-md-6 col-xs-8 border-green">
            <p><strong><?php echo t('Start fee');?></strong></p>
          </div>
          <div class="col-md-6 col-xs-4 border-green">
      ...
      <div class="row">
        <div class="col-md-10 col-md-offset-1">
          ...
          <ul>
            ...
            <li><?php echo t('De kredietverzekering adviseerd ABC Industrial Parts bv een voorafbetaling te vragen');?></li>
      ...
      <form  action="<?php echo $linkSign?>" method="post">
        <div class="row">
          <div class="col-md-10 col-md-offset-1">
            ...
            <div class="buttons">
              <input type="submit" class="btn" value="<?php echo t('Akkoord')?>">
              <input type="submit" class="btn decl" value="<?php echo t('Annuleren')?>" formaction="javascript:history.go(-1)">
            </div>
        </div>
        </div>
      </form>
...
<?php }elseif($signed == 'signed'){  ?>
  ...
  <div class="row">
    <div class="col-md-10 col-md-offset-1">
      <h2><?php echo t('Overeenkomst interventies ter plaatse 2021')?></h2>
      <p><?php echo t('Gelieve uw bedrijfsgegevens in te vullen')?></p>
    </div>
  </div>
  <br>
  <form action="<?php echo $linkReview?>" method="post">
    <div class="row">
      <div class="col-md-4 col-md-offset-1">
        <?php
          print $form->label('compName', t('Bedrijfsnaam'), array('style' => 'font-size: 14px;'));
          print $form->text('compName', array('required' => 'required'));
        ?>
      </div>
    </div>
    <div class="row">
      <div class="col-md-4 col-md-offset-1">
        <?php
          print $form->label('street', t('Straat + nummer'), array('style' => 'font-size: 14px;'));
          print $form->text('street', array('required' => 'required'));
        ?>
      </div>
    </div>
    <div class="row">
      <div class="col-md-2 col-md-offset-1">
        <?php
          print $form->label('zipcode', t('Postcode'), array('style' => 'font-size: 14px;'));
          print $form->text('zipcode', array('required' => 'required'));
        ?>
      </div>
      <div class="col-md-2">
        <?php
          print $form->label('city', t('Stad'), array('style' => 'font-size: 14px;'));
          print $form->text('city', array('required' => 'required'));
        ?>
      </div>
    </div>
    <div class="row">
      <div class="col-md-4 col-md-offset-1">
        <?php
          print $form->label('vat', t('Btw'), array('style' => 'font-size: 14px;'));
          print $form->text('vat', array('required' => 'required'));
        ?>
      </div>
    </div>
    ...
    <div class="row">
      <div class="col-md-4 col-md-offset-1">
        <?php
          print $form->label('contact', t('Contactpersoon'), array('style' => 'font-size: 14px;'));
          print $form->text('contact', array('required' => 'required'));
        ?>
      </div>
    </div>
    <div class="row">
      <div class="col-md-4 col-md-offset-1">
        <?php
          print $form->label('email', t('E-mail'), array('style' => 'font-size: 14px;'));
          print $form->text('email', array('required' => 'required'));
        ?>
      </div>
    </div>
    <div class="row">
      <div class="col-md-4 col-md-offset-1">
        <?php print $form->submit('submit', t('Volgende'), array('class' => 'btn btnNext'));?>
      </div>
    </div>
  </form>
<?php } ?>
